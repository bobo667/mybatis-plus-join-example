...
-- ----------------------------
BEGIN;
INSERT INTO `users` VALUES (NULL, 1, '{\"name\": \"123\", \"content\": \"牛蛙牛蛙\"}', '名字啊', '2021-10-28 18:17:50', 1);
INSERT INTO `users` VALUES (NULL, 2, '{\"name\": \"456\", \"content\": \"呜呜呜\"}', '名字2', '2021-10-28 18:17:50', 1);
COMMIT;
...
CREATE TABLE `users_age` (
  ...
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户年龄';

-- ----------------------------
-- Records of users_age
-- ----------------------------
BEGIN;
INSERT INTO `users_age` VALUES (1, '90', '90', '2021-12-17 13:11:11');
COMMIT;
